...
/**
 * Build Complete Google Apps Script with Responsive Curriculum HTMLs
 */

const fs = require('fs');

console.log('🔧 Building Google Apps Script with responsive curriculum HTMLs...');
console.log('');

// Read the curriculum HTMLs
console.log('📄 Reading Young Explorers HTML (responsive)...');
const youngHTML = fs.readFileSync('pdf-curriculum-young-explorers-responsive.html', 'utf8');
console.log(`   Size: ${(Buffer.byteLength(youngHTML, 'utf8') / 1024).toFixed(2)} KB`);

console.log('📄 Reading Teen Champions HTML (responsive + minified)...');
const teenHTML = fs.readFileSync('pdf-curriculum-teen-champions-responsive-minified.html', 'utf8');
console.log(`   Size: ${(Buffer.byteLength(teenHTML, 'utf8') / 1024).toFixed(2)} KB`);

console.log('📄 Reading Future Leaders HTML (responsive + minified)...');
const futureHTML = fs.readFileSync('pdf-curriculum-future-leaders-responsive-minified.html', 'utf8');
...
fs.writeFileSync('google-apps-script-curriculum-RESPONSIVE.js', script, 'utf8');

const stats = fs.statSync('google-apps-script-curriculum-RESPONSIVE.js');
const lines = script.split('\n').length;

console.log('✅ Google Apps Script created successfully!');
console.log('');
console.log('📊 Final Script Statistics:');
console.log(`   File: google-apps-script-curriculum-RESPONSIVE.js`);
console.log(`   Size: ${Math.round(stats.size / 1024)} KB`);
console.log(`   Lines: ${lines.toLocaleString()}`);
console.log('');
console.log('📋 Embedded Curriculum Sizes:');
console.log(`   Young Explorers: ${(Buffer.byteLength(youngHTML, 'utf8') / 1024).toFixed(2)} KB (responsive)`);
console.log(`   Teen Champions: ${(Buffer.byteLength(teenHTML, 'utf8') / 1024).toFixed(2)} KB (responsive + minified)`);
console.log(`   Future Leaders: ${(Buffer.byteLength(futureHTML, 'utf8') / 1024).toFixed(2)} KB (responsive + minified)`);
console.log('');
...
console.log('   ✅ Stacked header on mobile');
console.log('');
console.log('💻 Desktop Features:');
console.log('   ✅ UNCHANGED - Looks exactly the same');
console.log('   ✅ Side-by-side pricing cards');
console.log('   ✅ Large fonts');
console.log('   ✅ Generous padding');
console.log('');
console.log('🎯 Next Steps:');
console.log('   1. Open https://script.google.com');
console.log('   2. Open your "AI Kidz Club - Curriculum Download" project');
console.log('   3. Copy ALL contents of google-apps-script-curriculum-RESPONSIVE.js');
console.log('   4. Paste into Google Apps Script editor');
console.log('   5. Save and deploy');
console.log('   6. Run testAllCurricula() to verify!');
console.log('   7. Test on mobile devices (iOS Mail, Gmail app)');
console.log('');
console.log('✨ Ready to send responsive curriculum emails!');
