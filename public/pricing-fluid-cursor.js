// WebGL Fluid Splash Cursor - Vue Template Implementation
// Converted from Vue to Vanilla JavaScript
// Matches exact parameters from ReactBits Vue template
// Higher resolution, faster dissipation, full color spectrum

(function initFluidCursor() {
    const canvas = document.getElementById('fluid');
    if (!canvas) return;

    // Configuration - Exact Vue Template Parameters
    const config = {
        SIM_RESOLUTION: 128,
        DYE_RESOLUTION: 1440,
    ...
    // Random HSV color generation - Full spectrum
