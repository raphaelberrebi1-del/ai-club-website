// WebGL Fluid Splash Cursor - Full Implementation
// Converted from React to Vanilla JavaScript
// Original: https://github.com/DavidHDev/react-bits/blob/main/src/content/Animations/SplashCursor/SplashCursor.jsx
// Customized for AI Club with cyan/teal branding

(function initSplashCursor() {
    const canvas = document.getElementById('fluid-cursor');
    if (!canvas) return;

    // Configuration - AI Club Optimized
    const SIM_RESOLUTION = 128;
    const DYE_RESOLUTION = 1024; // Reduced from 1440 for better performance
    const CAPTURE_RESOLUTION = 512;
    const DENSITY_DISSIPATION = 1; // Slower dissipation for longer trails
    const VELOCITY_DISSIPATION = 0.2; // Slower velocity decay
    const PRESSURE = 0.8;
    const PRESSURE_ITERATIONS = 20;
    const CURL = 30; // Higher curl for more swirly effects
    ...
    updateFrame();
    console.log('WebGL Fluid Splash Cursor initialized - AI Club Edition');
})();
